...
extension Publishers {
    ...
    public struct Merge<A, B> : Publisher where A : Publisher, B : Publisher, A.Failure == B.Failure, A.Output == B.Output {
        ...
        public let observable: Observable<A.Output>
        ...
        public init(_ a: A, _ b: B) {
            self.a = a
            self.b = b
            observable = Observable.merge(a.observable, b.observable)
        }
    ...
    B.Failure == C.Failure, B.Output == C.Output {
        ...
        public init(_ a: A, _ b: B, _ c: C) {
            ...
            self.b = b
            self.c = c
            observable = Observable.merge(a.observable, b.observable, c.observable)
        }
    ...
    C.Failure == D.Failure, C.Output == D.Output {
        ...
        public init(_ a: A, _ b: B, _ c: C, _ d: D) {
            ...
            self.c = c
            self.d = d
            observable = Observable.merge(a.observable, b.observable, c.observable, d.observable)
        }
    ...
    D.Failure == E.Failure, D.Output == E.Output {
        ...
        public init(_ a: A, _ b: B, _ c: C, _ d: D, _ e: E) {
            ...
            self.d = d
            self.e = e
            observable = Observable.merge(a.observable, b.observable, c.observable, d.observable, e.observable)
        }
    ...
    E.Failure == F.Failure, E.Output == F.Output {
        ...
        public init(_ a: A, _ b: B, _ c: C, _ d: D, _ e: E, _ f: F) {
            ...
            self.e = e
            self.f = f
            observable = Observable.merge(a.observable, b.observable, c.observable, d.observable, e.observable, f.observable)
        }
    ...
    F.Failure == G.Failure, F.Output == G.Output {
        ...
        public init(_ a: A, _ b: B, _ c: C, _ d: D, _ e: E, _ f: F, _ g: G) {
            ...
            self.f = f
            self.g = g
            observable = Observable.merge(a.observable, b.observable, c.observable, d.observable, e.observable, f.observable, g.observable)
        }
    ...
    G.Failure == H.Failure, G.Output == H.Output {
        ...
        public init(_ a: A, _ b: B, _ c: C, _ d: D, _ e: E, _ f: F, _ g: G, _ h: H) {
            ...
            self.g = g
            self.h = h
            observable = Observable.merge(a.observable, b.observable, c.observable, d.observable, e.observable, f.observable, g.observable, h.observable)
        }
    }
    ...
    public struct MergeMany<Upstream> : Publisher where Upstream : Publisher {
        ...
        public init(_ upstream: Upstream...) {
            ...
            observable = Observable.merge(upstream.map { $0.observable })
        }
